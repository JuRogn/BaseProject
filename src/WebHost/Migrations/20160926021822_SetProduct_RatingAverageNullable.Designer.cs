...
namespace WebHost.Migrations
{
    ...
    [Migration("20160926021822_SetProduct_RatingAverageNullable")]
    partial class SetProduct_RatingAverageNullable
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Module.Core.Models.UrlSlug", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Module.Core.Models.User", b =>
                {
                    b.HasOne("Module.Core.Models.UserAddress", "CurrentShippingAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("Module.Orders.Models.Order", b =>
                {
                    b.HasOne("Module.Core.Models.UserAddress", "BillingAddress")
                        .WithMany()
                    ...
                    b.HasOne("Module.Core.Models.UserAddress", "ShippingAddress")
                        .WithMany()
