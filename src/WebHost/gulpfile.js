...
gulp.task('copy-modules', ['clean-module'], function () {
    modules.forEach(function (module) {
        gulp.src(mPaths.devModules + module.fullName + '/Views/**/*.*')//, { base: module.fullName }
            .pipe(gulp.dest(mPaths.hostModules + module.fullName +"/Views"));
        gulp.src( mPaths.devModules + module.fullName + '/module.json')//, { base: module.fullName })
    ...
    gulp.src(mPaths.devModules + 'Module.SampleData/SampleContent/**/*.*')
            .pipe(gulp.dest(mPaths.hostModules + 'Module.SampleData/SampleContent'));
});
...
function loadModules() {
    ...
    moduleManifestPaths = glob.sync(mPaths.devModules + 'Module.*/module.json', {});
