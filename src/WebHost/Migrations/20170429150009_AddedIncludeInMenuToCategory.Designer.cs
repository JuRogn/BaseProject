...
namespace WebHost.Migrations
{
    ...
    [Migration("20170429150009_AddedIncludeInMenuToCategory")]
    partial class AddedIncludeInMenuToCategory
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Module.Cms.Models.Menu", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Module.Cms.Models.MenuItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Module.Contacts.Models.Contact", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Module.Contacts.Models.ContactArea", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Module.Core.Models.AppSetting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Module.Core.Models.Vendor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Module.News.Models.NewsCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Module.News.Models.NewsItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Module.News.Models.NewsItemCategory", b =>
                {
                    b.Property<long>("CategoryId");
            ...
            modelBuilder.Entity("Module.ProductComparison.Models.ComparingProduct", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Module.Cms.Models.MenuItem", b =>
                {
                    b.HasOne("Module.Core.Models.Entity", "Entity")
                        .WithMany()
                        .HasForeignKey("EntityId");

                    b.HasOne("Module.Cms.Models.Menu", "Menu")
                        .WithMany("MenuItems")
                        .HasForeignKey("MenuId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Module.Cms.Models.MenuItem", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
                });
            ...
            modelBuilder.Entity("Module.Contacts.Models.Contact", b =>
                {
                    b.HasOne("Module.Contacts.Models.ContactArea", "ContactArea")
                        .WithMany()
            ...
            modelBuilder.Entity("Module.Core.Models.User", b =>
                {
                    ...
                    b.HasOne("Module.Core.Models.Vendor")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Module.News.Models.NewsItemCategory", b =>
                {
                    b.HasOne("Module.News.Models.NewsCategory", "Category")
                        .WithMany("NewsItems")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Module.News.Models.NewsItem", "NewsItem")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("Module.Orders.Models.Order", b =>
                {
                    ...
                    b.HasOne("Module.Orders.Models.Order", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
